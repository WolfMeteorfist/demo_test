...
public class MyViewDragHelper {
     ...
     */
    public static MyViewDragHelper create(ViewGroup forParent, MyViewDragHelper.Callback cb) {
     ...
     * @return a new MyViewDragHelper instance
     */
    public static MyViewDragHelper create(ViewGroup forParent, float sensitivity, MyViewDragHelper.Callback cb) {
     ...
     * @param forParent Parent view to monitor
     */
    private MyViewDragHelper(Context context, ViewGroup forParent, MyViewDragHelper.Callback cb) {
        if (forParent == null) {
     ...
     * The callback's {@link MyViewDragHelper.Callback#onEdgeTouched(int, int)} and
     * {@link MyViewDragHelper.Callback#onEdgeDragStarted(int, int)} methods will only be invoked
     ...
     * but {@link MyViewDragHelper.Callback#tryCaptureView(android.view.View, int)} will not be asked permission to
     * capture this view.
     *
     ...
     * The child order is determined using {@link MyViewDragHelper.Callback#getOrderedChildIndex(int)}.
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
